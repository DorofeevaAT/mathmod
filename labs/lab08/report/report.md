...
subtitle: "Модель конкуренции двух фирм - вариант 13"
...
$$\frac{dM_1}{d\Theta} = M_1 - (\frac{b}{c_1} + 0.0004)M_1 M_2 - \frac{a1}{c1} M_1^2 $$
...
$$ p_{cr}=11.5 \: N=35 \: q=1 $$
$$ \tau_1=18 \: \tau_2=28 $$
$$ \widetilde{p}_1=7.8 \: \widetilde{p}_2=5.7 $$
...
![График для случая 1, OpenModelica](image/1.png){ #fig:001 width=70% height=70% }

![График для случая 2, OpenModelica](image/2.png){ #fig:002 width=70% height=70% }
...
savefig("4.png")
```
![График для случая 1, Julia](image/3.png){ #fig:001 width=70% height=70% }

![График для случая 2, Julia](image/4.png){ #fig:002 width=70% height=70% }
