...
![График численности групп](image/11.png){ #fig:001 width=70% height=70% }

## Графики изменения численности во втором случае на OpenModelica

![График численности групп](image/12.png){ #fig:002 width=70% height=70% }

## Графики изменения численности в первом случае на Julia

![График численности групп](image/21.png){ #fig:001 width=70% height=70% }

## Графики изменения численности во втором случае на Julia

![График численности групп](image/22.png){ #fig:002 width=70% height=70% }
