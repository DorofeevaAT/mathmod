...
В начальный момент времени страна $X$ имеет армию численностью 40000 человек, а в распоряжении страны $Y$ армия численностью в 69000 человек.
...
$$
 \begin{cases}
	...
	\\   
	\frac{dy}{dt}= -0.54x(t) - 0.29y(t) + cos(t+20)+1
 \end{cases}
$$
