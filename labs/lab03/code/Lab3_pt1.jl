...
# ╔═╡ 0a8ed9de-b454-11ed-06fa-a53c4d95383a
begin
	using Plots
	...
	#= Потери, не связанные с боевыми действиями страны Х=#
	a = 0.35
	#= Эффективность боевых действий стороны Y=#
	b = 0.45
	#= Эффективность боевых действий армии Х=#
	c = 0.69
	#= Потери, не связанные с боевыми действиями страны Y=#
	h = 0.61

	#= Возможность подхода подкрепления к армии Х =#
	P(t) = 2*sin(t)
	#= Возможность подхода подкрепления к армии Y =#
	Q(t) = cos(t) + 1
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "757089e56fa9092d78c0de0043897d1ee87fce5a"
